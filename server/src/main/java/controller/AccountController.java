...
public class AccountController {
    ...
    public void save(Account account) {
        ...
        try {
            ...
            writer.writeValue(Paths.get(Constants.ACCOUNT_PATH_FILE).toFile(), accounts);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public ArrayList<Account> findAll() {
        ObjectMapper mapper = new ObjectMapper();
        if (Files.exists(Paths.get(Constants.ACCOUNT_PATH_FILE))) {
            try {
                return new ArrayList<>(Arrays.asList(mapper.readValue(Paths.get(Constants.ACCOUNT_PATH_FILE)
